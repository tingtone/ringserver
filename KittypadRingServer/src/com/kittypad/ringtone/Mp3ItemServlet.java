 ...
 */
public class Mp3ItemServlet extends HttpServlet{
	/**
	 * 
	 */
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response){
		...
		if(type.equals("m4r") || type.equals("aac") || type.equals("midi")){
		}
		else{
			Mp3Item.insert(keyStr, UUID, musicName, category, type, size);
		}		
	}
}
